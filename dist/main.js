        ...
        var pendingTransactionsTab_extends = undefined && undefined.__extends || function() {
            ...
            function PendingTransactionsTab(props) {
                ...
                return _this.state = {
                    ...
                    if (_this.props.setLoading(!1), -1 != purchase.purchaseIndex) {
            ...
            return pendingTransactionsTab_extends(PendingTransactionsTab, _super), PendingTransactionsTab.prototype.render = function() {
                ...
                }))), react.createElement("div", null, react.createElement("span", null, "Pending Transactions"), react.createElement("div", {
                    className: "flex flex-col"
                }, this.state.unreadPurchases.map((function(purchase, index) {
                    return react.createElement("div", {
                        className: "flex flex-row"
                    }, react.createElement("div", null, react.createElement("span", null, "Amount: ", purchase.amount), react.createElement("span", null, "Date: ", purchase.isoDate), react.createElement("span", null, "Description: ", purchase.description)), react.createElement("div", {
                        className: "flex flex-row"
                    }, react.createElement("button", {
                        onClick: function() {
                        ...
                        onClick: function() {
                            return alert("Delete: " + purchase.threadId);
                        }
                    }, "Delete")));
        ...
        var root_extends = undefined && undefined.__extends || function() {
            ...
            return root_extends(Root, _super), Root.prototype.setActiveTab = function(tabName) {
                ...
                return react.createElement("div", {
                    ...
                    className: "bg-white inline-block py-2 px-4 font-semibold ".concat("pendingTransactionsTab" === this.state.activeTabName ? "border-l border-t border-r rounded-t text-budget-dark" : "text-gray-400 hover:text-budget-light"),
                    ...
                    className: "bg-white inline-block py-2 px-4 font-semibold ".concat("monthlySummaryTab" === this.state.activeTabName ? "border-l border-t border-r rounded-t text-budget-dark" : "text-gray-400 hover:text-budget-light"),
                    disabled: this.state.loading,
                    onClick: function() {
