 ...
 */
    ...
    (() => {
        ...
        var extendStatics, __extends = undefined && undefined.__extends || (extendStatics = function(d, b) {
            ...
            return __extends(Root, _super), Root.prototype.setActiveTab = function(tabName) {
                this.setState({
                ...
                }, "pendingTransactionsTab" === this.state.activeTabName ? "pendingTransactionsTab" : null, "monthlySummaryTab" === this.state.activeTabName ? "monthlySummaryTab" : null));
            }, Root;
        }(react.Component);
