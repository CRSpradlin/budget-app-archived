 ...
 */
    ...
    (() => {
        ...
        !function(PurchaseCategory) {
            PurchaseCategory.Rent = "Rent", PurchaseCategory.Utilities = "Utilities", PurchaseCategory.Grocery = "Groceries", 
        ...
        var extendStatics, __extends = undefined && undefined.__extends || (extendStatics = function(d, b) {
            ...
            function GmailConfirmModal(props) {
                ...
                return _this.updateCategory = function(e) {
                    _this.props.setCategory(PurchaseCategory[e.target.value]);
                }, _this;
            }
            return __extends(GmailConfirmModal, _super), GmailConfirmModal.prototype.render = function() {
                ...
                return react.createElement(react.Fragment, null, react.createElement(tt, {
                ...
                }, "Confirm Category and Additional Tip"), react.createElement("div", {
                    ...
                    className: "w-[10rem] m-5 bg-budget-light hover:bg-budget-dark px-5 py-2 text-sm rounded-full font-semibold text-white"
        ...
        var pendingTransactionsTab_extends = undefined && undefined.__extends || function() {
            ...
            function PendingTransactionsTab(props) {
                ...
                return _this.state = {
                ...
                }, _this.handleFormSuccess = function(purchaseObj) {
                    _this.props.setLoading(!1);
                    var formObject, purchase = {
                        threadId: (formObject = purchaseObj).threadId ? formObject.threadId : undefined,
                    ...
                    if (purchase.purchaseIndex != undefined && -1 != purchase.purchaseIndex) {
            ...
            return pendingTransactionsTab_extends(PendingTransactionsTab, _super), PendingTransactionsTab.prototype.render = function() {
                ...
                return react.createElement("div", {
                    ...
                    className: "m-28"
                }, react.createElement("span", null, "Approve Pending Transactions"), react.createElement("div", {
                    className: "flex flex-col"
                }, this.state.unreadPurchases.map((function(purchase, index) {
                    return react.createElement("div", {
                        className: "flex flex-row items-center justify-center border-t-2 border-indigo-900"
                    }, react.createElement("div", {
                        className: "flex flex-col w-5/6 items-start"
                    }, react.createElement("span", null, "Amount: ", purchase.amount), react.createElement("span", null, "Date: ", purchase.isoDate), react.createElement("span", null, "Description: ", purchase.description)), react.createElement("div", {
                        className: "flex flex-row"
                    }, react.createElement("button", {
                        onClick: function() {
        ...
        var root_extends = undefined && undefined.__extends || function() {
            ...
            return root_extends(Root, _super), Root.prototype.setActiveTab = function(tabName) {
                ...
                return react.createElement("div", {
                    ...
                    className: "inline-block py-2 px-4 font-semibold ".concat("pendingTransactionsTab" === this.state.activeTabName ? "border-l border-t border-r rounded-t text-budget-dark" : "text-gray-400 hover:text-budget-light"),
                    ...
                    className: "inline-block py-2 px-4 font-semibold ".concat("monthlySummaryTab" === this.state.activeTabName ? "border-l border-t border-r rounded-t text-budget-dark" : "text-gray-400 hover:text-budget-light"),
                    disabled: this.state.loading,
                    onClick: function() {
                ...
                }) : null, "monthlySummaryTab" === this.state.activeTabName ? "monthlySummaryTab" : null));
            }, Root;
        }(react.Component);
