        ...
        /* harmony default export */ const monthlySummaryTab = function(_super) {
            ...
            return monthlySummaryTab_extends(MonthlySummaryTab, _super), MonthlySummaryTab.prototype.render = function() {
                ...
                return react.createElement("div", {
                    ...
                    className: "text-budget-dark text-2xl p-6"
                }, "This Month's Category Totals"), Object.keys(this.state.categories).map((function(category, index) {
                    return react.createElement("div", {
                        className: "flex flex-row items-center justify-center border-t-2 border-indigo-900"
                    }, react.createElement("div", {
                        className: "flex flex-col w-5/6 items-start"
                        ...
                        className: "text-lg font-bold"
                    }, "Category: $", category), react.createElement("span", {
                        className: "text-lg font-bold"
                    }, "Monthly Total: $", _this.state.categories[category])));
                }))), react.createElement("div", null, react.createElement("span", {
                    className: "text-budget-dark text-2xl p-6"
                }, "This Month's Purchases"), this.state.purchases.map((function(purchase, index) {
                    return react.createElement("div", {
                        className: "flex flex-row items-center justify-center border-t-2 border-indigo-900"
                    }, react.createElement("div", {
                        className: "flex flex-col w-5/6 items-start"
                        ...
                        className: "text-lg font-bold"
                    }, "Amount: $", purchase.amount), react.createElement("span", null, "Description: ", purchase.description), react.createElement("span", null, "Date: ", purchase.isoDate)));
                }))));
            }, MonthlySummaryTab;
        }(react.Component);
